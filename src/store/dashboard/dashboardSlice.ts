...
export const { traerClientes, modificarClientes, agregarCliente, eliminarCliente, clearDashboardData, traerProductos, agregarProducto, modificarProductos } = dashboardSlice.actions;